...
const tradeSchema = new mongoose_1.Schema({
    ...
    event: { type: mongoose_1.Schema.Types.ObjectId, required: true, ref: 'Event', index: true },
    amount: { type: Number, required: true, min: 0 },
    choice: { type: String, required: true },
    status: { type: String, enum: ['pending', 'won', 'lost', 'settled'], default: 'pending' }, // Add 'settled'
}, { timestamps: true });
